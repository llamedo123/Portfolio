...
function copyEmailText() {
    ...
    navigator.clipboard.writeText("jamescarl.llamedo@ctu.edu.ph");
    alert("Email: llamedojamescarl3221@gmail.com");
    }
function copyLinkedInText() {
        //var copyText = document.getElementById("linkedinCopy");
        navigator.clipboard.writeText("http://www.linkedin.com/in/llamedojamescarl3221");
        alert("Linked Link: http://www.linkedin.com/in/llamedojamescarl3221");
        }
function copyPortfolioText() {
            //var copyText = document.getElementById("portfolioCopy");
            navigator.clipboard.writeText("James Carl Llamedo");
            alert("No link Provided Yet");
            }